...
(ert-deftest sqlind-ert-dsed-begin-work ()
  (sqlind-ert-check-file-syntax "test-data/dsed-begin-work.sql"
                                "test-data/dsed-begin-work-syn.eld"))

(ert-deftest sqlind-ert-dsed-plpgsql-declare ()
  (sqlind-ert-check-file-syntax "test-data/dsed-plpgsql-declare.sql"
                                "test-data/dsed-plpgsql-declare-syn.eld"))

(ert-deftest sqlind-ert-dsed-cte-on-dml ()
  (sqlind-ert-check-file-syntax "test-data/dsed-cte-on-dml.sql"
                                "test-data/dsed-cte-on-dml-syn.eld"))

(ert-deftest sqlind-ert-dsed-update-clauses ()
  (sqlind-ert-check-file-syntax "test-data/dsed-update-clauses.sql"
                                "test-data/dsed-update-clauses-syn.eld"))

(ert-deftest sqlind-ert-dsed-create-temp-table ()
  (sqlind-ert-check-file-syntax "test-data/dsed-create-temp-table.sql"
                                "test-data/dsed-create-temp-table-syn.eld"))
